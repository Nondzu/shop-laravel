            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-3">
                            <label for="name" maxlength="500" class="col-md-4 col-form-label text-md-end">Nazwa</label>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <textarea id="description" maxlength="1500" class="form-control" name="description"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="amount" type="number" min="0" class="form-control " name="amount"
