    ...
    <div class="container pt-5">
        <div class="row">
                            ...
                            <div class="col-6 col-md-6 col-lg-4 mb-3">
                                <div class="card h-100 border-0">
                                    <div class="card-img-top">
                                        ...
                                        @else
                                            <img src="{{ $defaultImage }}" class="img-fluid mx-auto d-block"
                                                alt="Product image">
                                        @endif
                                    </div>
                                    <div class="card-body text-center">
                                        ...
                                        <button class="btn btn-success btn-sm add-cart-button"
            ...
            <form class="col-md-4 order-md-1 col-lg-3 sidebar-filter">
                <h3 class="mt-0 mb-5">{{ __('shop.welcome.products') }} <span
                        class="text-primary">{{ count($products) }}</span>
                </h3>
                ...
                <div class="price-filter-control">
                    <input type="number" class="form-control w-50 pull-left mb-2" placeholder="50" name="filter[price_min]"
                        id="price-min-control">
                    <input type="number" class="form-control w-50 pull-right" placeholder="150" name="filter[price_max]"
