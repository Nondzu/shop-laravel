                        ...
                        <div class="cart_container">
                                        ...
                                        <li class="cart_item clearfix">
                                            ...
                                            <div
                                                ...
                                                <div class="cart_item_quantity cart_info_col">
                                                    <div class="cart_item_title">{{ __('shop.product.fields.amount') }}
                                                    </div>
                                                ...
                                                <div class="cart_item_total cart_info_col">
                                                    <div class="cart_item_title">{{ __('shop.product.fields.sum') }} [PLN]
                                                    </div>
                            ...
                            <div class="order_total">
                                <div class="order_total_content text-md-right">
                                    <div class="order_total_title">{{ __('shop.product.fields.sum_order') }} [PLN]:</div>
                                    <div class="order_total_amount">{{ $cart->getSum() }}</div>
                                </div>
                            </div>
                            <div class="cart_buttons">
                                <a href="/" type="button" class="button cart_button_clear">{{ __('shop.button.continue_shopping') }}</a>

                                <button type="button" class="button cart_button_checkout" disabled>{{ __('shop.button.payment') }}</button>
                            </div>
                        </div>
                    </div>
                </div>
